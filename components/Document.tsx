    ...
    <div className='w-fit hover:scale-101 hover:-translate-y-0.5 hover:translate-x-0.5 duration-700 cursor-pointer'>
        <div className='flex items-center justify-between'>
            ...
            <div className='flex justify-end pr-3'>
                <Button className='px-0 py-0' icon={<span className='material-symbols-outlined'>send</span>}></Button>
                <Button className='px-0 py-0' icon={<span className='material-symbols-outlined'>download</span>}></Button>
            </div>
        </div>
